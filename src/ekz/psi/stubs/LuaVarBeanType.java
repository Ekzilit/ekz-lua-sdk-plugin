...
public class LuaVarBeanType extends IStubElementType<LuaVarBeanStub, LuaClassVarDefinition> {
	...
	@NotNull
	@Override
	public LuaVarBeanStub createStub(@NotNull final LuaClassVarDefinition classVarDefinition, final StubElement stubElement) {
	...
	public boolean shouldCreateStub(ASTNode node) {
		...
		return indicators.length == 1 && indicators[0].getChildren(TokenSet.create(LuaTypes.CLASS_VAR_BEAN_TYPE)).length == 1;
	}
}